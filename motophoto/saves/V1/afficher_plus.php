...
function enqueue_load_more_script() {
    wp_enqueue_script('load-more', get_stylesheet_directory_uri() . '/assets/js/afficher_plus.js', array('jquery'), null, true);

    // Passer l'URL d'admin-ajax.php et le nonce pour la sécurité
